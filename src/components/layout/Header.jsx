...
// Quan arribi el logotip: substitueix el <h1> per <img src="/logo.svg" alt="BalearsPolitic" className="h-14 md:h-20" />

export default function Header() {
  return (
    <header className="relative overflow-hidden">

      {/* ── Mesh gradient — més lluminós ── */}
      <div
      ...
      {/* ── Scrim suau — menys opacitat per deixar passar el gradient ── */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-10 md:py-14">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="font-mono text-[10px] tracking-[3px] uppercase text-white/75">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
          <div>
            {/* LOGO — substituir per <img> quan arribi */}
            <h1 className="font-display text-5xl md:text-7xl font-black leading-none tracking-[-3px] mb-3 drop-shadow-md">
              <span className="text-white">Balears</span>
              <span style={{ color: '#43F8CC' }}>Politic</span>
            </h1>
            <p className="text-sm text-white/85 font-light max-w-md leading-relaxed">
          ...
          <div className="flex gap-6 flex-wrap">
            {[
              ...
              <div key={l} className="border-l border-white/30 pl-4">
                <div className="font-display text-3xl font-extrabold leading-none text-white drop-shadow">{n}</div>
        ...
        {/* Parliament bar */}
        <div className="mt-8">
          <div className="font-mono text-[9px] tracking-[2px] uppercase text-white/55 mb-2">
            XI Legislatura 2023 · 59 escons
          </div>
          <div className="flex h-2 rounded overflow-hidden shadow">
            {[
