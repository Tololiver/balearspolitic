    ...
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="space-y-8">
        <Section title="1. Titular del web">
          <p>BalearsPolitic és un projecte de <strong>Tolo Oliver</strong>, amb domicili a les Illes Balears, Espanya. Contacte: <a href="mailto:boocman@gmail.com" className="text-accent hover:underline">boocman@gmail.com</a></p>
        </Section>
        ...
        <Section title="3. Propietat intel·lectual">
          <p>Els continguts d'aquest web (textos, anàlisis, estructures de dades i codi) són propietat de BalearsPolitic. Les dades electorals i institucionals provenen de fonts públiques (Govern de les Illes Balears, Parlament, ajuntaments, fonts periodístiques).</p>
        ...
        <Section title="5. Neutralitat editorial">
          <p>BalearsPolitic és una eina d'anàlisi independent i no té cap afiliació política. L'objectiu és presentar la informació de forma equilibrada i verificada. Si detectes un error o consideres que algun contingut és parcial, posa't en contacte: <a href="mailto:boocman@gmail.com" className="text-accent hover:underline">boocman@gmail.com</a></p>
        </Section>
